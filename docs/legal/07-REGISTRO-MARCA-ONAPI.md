# 07 — Registro de Marca "OKLA" ante ONAPI

> **Prioridad:** 🟡 MEDIA  
> **Tiempo estimado:** 6-12 meses (proceso completo)  
> **Costo:** RD$5,000-10,000 por clase + honorarios de abogado  
> **Responsable:** Gerencia General + Abogado de Propiedad Intelectual  
> **Entidad:** Oficina Nacional de la Propiedad Industrial (ONAPI)
...
- **Valor comercial** del activo intangible (marca registrada)
- **Requisito** para licenciamiento y franquicias futuras
...
- Vulnerabilidad ante demandas por infracción (si alguien más lo registra primero)

---

## 2. Búsqueda Previa de Disponibilidad

### Paso 1: Búsqueda en ONAPI (ANTES de solicitar)

**⚠️ CRÍTICO:** Antes de invertir en el registro, verificar que "OKLA" no esté ya registrada.

1. Ir a **onapi.gov.do** → "Servicios en Línea" → "Búsqueda de Marcas"
2. Buscar "OKLA" en todas las clases
3. Buscar también variaciones: "OKLA.DO", "OKLA RD", "OKLA MOTORS"
...
- Un abogado de propiedad intelectual puede hacer esta búsqueda
...
## 3. Clases a Registrar (Clasificación de Niza)
...
## 4. Proceso de Registro Paso a Paso
...
- Poder de representación (si lo presenta un abogado)
- Logotipo en formato digital (si se registra como marca mixta)
- Especificación de productos/servicios por clase
...
### Paso 2: Presentar la Solicitud (Semana 2)

1. Ir a ONAPI o presentar a través de la plataforma digital
2. Completar el formulario con:
   - Datos del solicitante (OKLA como empresa)
   - Marca a registrar: "OKLA"
   - Clase(s) seleccionada(s)
...
Si hay observaciones, ONAPI notificará para corrección (plazo: 60 días).
...
4. Si no hay oposición → la solicitud avanza
...
- [ ] Búsqueda de disponibilidad realizada en ONAPI
- [ ] Búsqueda profesional de anterioridades completada
- [ ] Abogado de propiedad intelectual contratado
- [ ] Clases a registrar definidas
- [ ] Solicitud de marca nominativa preparada
- [ ] Solicitud presentada ante ONAPI
- [ ] Tasas pagadas
- [ ] Examen de forma superado
- [ ] Publicación en Boletín sin oposiciones
- [ ] Examen de fondo superado
- [ ] Certificado de registro recibido
- [ ] Solicitud de marca mixta (logotipo) preparada
- [ ] Sistema de vigilancia de marca establecido
- [ ] Calendario de renovación programado (10 años)
