...
namespace ComparisonService.Application.Validators;

/// <summary>
/// Security validators for FluentValidation to prevent SQL injection and XSS attacks.
/// Apply .NoSqlInjection() and .NoXss() to all user-facing string inputs.
/// </summary>
