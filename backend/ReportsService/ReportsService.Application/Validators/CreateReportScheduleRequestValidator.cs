...
public class CreateReportScheduleRequestValidator : AbstractValidator<CreateReportScheduleRequest>
{
    private static readonly string[] ValidFrequencies = { "Once", "Daily", "Weekly", "Monthly", "Quarterly", "Yearly" };

    public CreateReportScheduleRequestValidator()
    {
