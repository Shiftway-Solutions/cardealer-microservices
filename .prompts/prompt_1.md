# RE-AUDITORÍA (Verificación de fixes, intento 1/3) — Sprint 14: Errores y Edge Cases — La Plataforma es Amigable
**Fecha:** 2026-04-01 22:58:09
**Fase:** REAUDIT
...
Esta es la re-verificación del Sprint 14 (intento 1/3).
...
**Pasos:**
- [ ] Paso 1: Navega a {BASE_URL}/pagina-que-no-existe
- [ ] Paso 2: Toma screenshot — ¿404 diseñado con estilo OKLA?
- [ ] Paso 3: ¿Tiene link a home? ¿Buscador? ¿Sugerencias?
- [ ] Paso 4: Navega a {BASE_URL}/vehiculos/slug-que-no-existe-xyz
- [ ] Paso 5: Toma screenshot — ¿404 de vehículo con 'Vehículos similares'?
- [ ] Paso 6: Sin estar loggeado, navega a {BASE_URL}/admin
- [ ] Paso 7: Toma screenshot — ¿redirige al login? ¿O 403?
- [ ] Paso 8: Login como buyer (buyer002@okla-test.com / BuyerTest2026!)
- [ ] Paso 9: Navega a {BASE_URL}/admin
- [ ] Paso 10: Toma screenshot — ¿403 con mensaje claro? ¿Link a home?
- [ ] Paso 11: Navega a {BASE_URL}/dealer/dashboard (como buyer, no como dealer)
- [ ] Paso 12: ¿Me bloquea correctamente?
...
**Pasos:**
- [ ] Paso 1: Navega a {BASE_URL}/login — envía con campos vacíos
- [ ] Paso 2: ¿Hay validación client-side? ¿Mensaje claro en español?
- [ ] Paso 3: Envía con email malformado (ej: 'noesmail') → ¿error claro?
- [ ] Paso 4: Navega a {BASE_URL}/registro — envía con campos vacíos
- [ ] Paso 5: Contraseñas que no coinciden → ¿error claro?
- [ ] Paso 6: Navega a {BASE_URL}/contacto — envía con campos vacíos
- [ ] Paso 7: ¿Validación en todos los campos requeridos?
- [ ] Paso 8: Login en Tab A como buyer, cierra sesión en Tab B
- [ ] Paso 9: En Tab A intenta navegar → ¿detecta sesión expirada?
- [ ] Paso 10: Toma screenshot de cada error encontrado
