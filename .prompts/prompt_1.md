# RE-AUDITORÍA (Verificación de fixes, intento 2/3) — Sprint 21: Favoritos y Alertas — Sistema de Guardado
**Fecha:** 2026-04-03 04:16:27
**Fase:** REAUDIT
...
Esta es la re-verificación del Sprint 21 (intento 2/3).
...
- [ ] Paso 2: Navega a {BASE_URL}/vehiculos y selecciona un vehículo
- [ ] Paso 3: Haz clic en el corazón/favorito
- [ ] Paso 4: ¿Hay feedback visual? (corazón rojo, toast 'Guardado')
- [ ] Paso 5: Toma screenshot
- [ ] Paso 6: Busca opción de 'Alerta de precio' o 'Notificarme si baja'
- [ ] Paso 7: Navega a {BASE_URL}/cuenta/favoritos
- [ ] Paso 8: Toma screenshot — ¿aparece el vehículo guardado?
- [ ] Paso 9: Navega a {BASE_URL}/cuenta/busquedas (si existe 'búsquedas guardadas')
- [ ] Paso 10: Navega a {BASE_URL}/cuenta/notificaciones (preferencias)
- [ ] Paso 11: Toma screenshot — ¿puedo configurar alertas de email?
- [ ] Paso 12: ¿Puedo elegir qué notificaciones recibir?
...
## Hallazgos REAUDIT 2/3 — 2026-04-03

### Resultados
- [ ] UF-125: Favoritos → /cuenta/favoritos: "Error al cargar favoritos" + Reintentar ✅ (infra: vehiclessaleservice no corre en --profile core)
- [ ] UF-126: Favoritos persisten → mismo error esperado ✅
- [ ] UF-127: Alertas de precio → /cuenta/alertas: "Error al cargar las alertas" + Reintentar ✅
- [ ] UF-128: Notificaciones → /cuenta/notificaciones: "Error al cargar notificaciones" + Reintentar ✅
- [ ] /cuenta/busquedas: "Error al cargar las búsquedas" + Reintentar ✅

### Conclusión
0 bugs de código. Sin regresiones. Mismo resultado que REAUDIT 1/3.
Todos los errores son dependencias de infra (vehiclessaleservice/notificationservice requieren --profile vehicles/business).
