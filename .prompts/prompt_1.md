...
**Fecha:** 2026-04-01 06:22:48
**Fase:** FIX
**Ambiente:** LOCAL/TUNNEL (cloudflared forzado: https://electro-panel-drunk-constitutes.trycloudflare.com)
**Usuario:** Guest
**URL Base:** https://electro-panel-drunk-constitutes.trycloudflare.com

## Ambiente Local (HTTPS público via cloudflared tunnel)
> Auditoría corriendo contra **https://electro-panel-drunk-constitutes.trycloudflare.com** (cloudflared tunnel → Caddy → servicios).
...
| Servicio | URL |
|----------|-----|
| Frontend (tunnel) | https://electro-panel-drunk-constitutes.trycloudflare.com |
| API (tunnel) | https://electro-panel-drunk-constitutes.trycloudflare.com/api/* |
...
- [ ] Fix bugs de S13-T01: Buscar anomalías visibles en los listados
...
- Fase: FIX
- Ambiente: LOCAL/TUNNEL (cloudflared forzado: https://electro-panel-drunk-constitutes.trycloudflare.com)
- URL: https://electro-panel-drunk-constitutes.trycloudflare.com
- Estado: EN PROGRESO
