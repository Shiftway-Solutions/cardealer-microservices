...
export interface PlatformPricing {
  ...
  sellerVerificado: number; // $34.99/mes (DOP 2029)
...
const DEFAULT_PRICING: PlatformPricing = {
  ...
  dealerPro: 5742, // $99 USD
  dealerElite: 20242, // $349 USD
  dealerEnterprise: 34742, // $599 USD
  // Planes Seller Individual v5.0 (DOP) — LIBRE / ESTÁNDAR($9.99/listing) / VERIFICADO($34.99/mes)
  sellerGratis: 0,
  sellerEstandar: 579, // $9.99 USD → DOP 579
  sellerVerificado: 2029, // $34.99 USD → DOP 2029
  // Legacy aliases
  sellerPremium: 579,
  sellerProPlan: 2029,
  // Boosts
